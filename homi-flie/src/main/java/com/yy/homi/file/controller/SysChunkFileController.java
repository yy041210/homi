...
public class SysChunkFileController {
    ...
    public R uploadChunk(@Validated @RequestBody UploadChunkReqDTO uploadChunkReqDTO){
    ...
    public R checkChunk(@RequestParam("taskId") @NotBlank String taskId, @RequestParam("chunkIndex") int chunkIndex){
    ...
    public R mergeChunk(@RequestParam("taskId") @NotBlank String taskId){
